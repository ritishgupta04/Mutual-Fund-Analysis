...
🔗 [Mutual_Funds.csv](./Mutual_Funds.csv)  
...
🔗 [Dashboard Preview Image](./Mutual_Fund_Dashboard.png)
...
![Mutual Fund Dashboard Preview](./Mutual_Fund_Dashboard.png)
...
| File | Description |
|------|-------------|
| [Mutual_Funds.csv](./Mutual_Funds.csv) | Main dataset |
| [Mutual Fund Analysis.ipynb](./Mutual%20Fund%20Analysis.ipynb) | Jupyter notebook analysis |
...
| [Mutual Fund Dashboard.png](./Mutual_Fund_Dashboard.png) | Dashboard image preview |
...
📩 Connect with me on [GitHub](https://github.com/ritishgupta04)  
📧 Or drop an email: **ritishgupta04@gmail.com**
